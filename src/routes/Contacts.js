const Contacts= () => {
    ...
    return (
        <div className="h-screen mt-[5rem] px-24 dark:bg-dark">
            ...
            <div className="content flex flex-row justify-center items-start">
                <form className="left-side w-1/2 h-full pr-56 flex flex-col justify-start items-start">
                    <h2 className="font-martelbold text-2xl text-grey mb-8 dark:text-white">Write me your idea:</h2>
                ...
                <div className="right-side pl-56  w-1/2 flex flex-col justify-start items-start">
                    <h3 className="font-martelbold text-2xl text-grey mb-8 dark:text-white">Reach me on my contacts:</h3>
